...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($crud->actualizarDato($id, $nombres, $apPater, $apMater, $celular, $direccion, $telRefe)) {
...
<div class="container mt-5">
    ...
    <h5>Ingresar datos para actualizar el paciente:</h5> <br>
    <form method="post" action="">
        <input type="hidden" class="form-control" id="idPaciente" name="idPaciente" value="<?php echo $_GET['idPaciente']; ?>">
        <div class="mb-3">
    ...
    if ($data) {
        ...
        echo '<thead><tr><th>ID Paciente</th><th>Nombres</th><th>Apellido Paterno</th><th>Apellido Materno</th><th>Celular</th><th>Direccion</th><th>Telefono Ref.</th></tr></thead>';
        echo '<tbody>';
        ...
        echo '<p class="text-center">No se pudo obtener la información.</p>';
    }
    ?>
